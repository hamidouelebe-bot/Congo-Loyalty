...
const ShopperStaticPage: React.FC<ShopperStaticPageProps> = ({ onNavigate, pageData, lang, isLoggedIn = false }) => {
  const handleBack = () => {
    // Navigate to Profile if logged in, else to Landing
    onNavigate(isLoggedIn ? AppView.ShopperProfile : AppView.Landing);
  };
