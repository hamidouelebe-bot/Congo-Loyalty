...
export const MOCK_USERS: User[] = [
  { id: '1', firstName: 'Jean', lastName: 'Kabeya', email: 'jean.k@example.com', phoneNumber: '+243 81 123 4567', status: UserStatus.Active, pointsBalance: 1250, pointsExpiring: 200, nextExpirationDate: '2024-06-30', pointsExpiresAt: '2024-06-30', totalSpent: 45000, joinedDate: '2023-11-15', gender: 'Male', birthdate: '1990-05-15', pin: '1234' },
  { id: '2', firstName: 'Marie', lastName: 'Lumba', email: 'marie.l@example.com', phoneNumber: '+243 99 876 5432', status: UserStatus.Active, pointsBalance: 3400, pointsExpiring: 0, nextExpirationDate: null, pointsExpiresAt: null, totalSpent: 120000, joinedDate: '2023-10-01', gender: 'Female', birthdate: '1985-11-20', pin: '1234' },
  { id: '3', firstName: 'Patrick', lastName: 'Mbuyi', email: 'pat.mbuyi@example.com', phoneNumber: '+243 82 555 0101', status: UserStatus.Suspended, pointsBalance: 0, pointsExpiring: 0, nextExpirationDate: null, pointsExpiresAt: null, totalSpent: 1500, joinedDate: '2024-01-20', gender: 'Male', birthdate: '1998-02-10', pin: '1234' },
  { id: '4', firstName: 'Sarah', lastName: 'Ngalula', email: 's.ngalula@gmail.com', phoneNumber: '+243 90 000 1122', status: UserStatus.Banned, pointsBalance: 0, pointsExpiring: 0, nextExpirationDate: null, pointsExpiresAt: null, totalSpent: 500, joinedDate: '2024-02-10', gender: 'Female', birthdate: '2000-07-04', pin: '1234' },
  { id: '5', firstName: 'David', lastName: 'Ilunga', email: 'david.il@hotmail.com', phoneNumber: '+243 85 444 3322', status: UserStatus.Active, pointsBalance: 560, pointsExpiring: 50, nextExpirationDate: '2024-07-15', pointsExpiresAt: '2024-07-15', totalSpent: 22000, joinedDate: '2023-12-05', gender: 'Male', birthdate: '1992-09-30', pin: '1234' },
];
